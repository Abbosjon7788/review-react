                    ...
                    <div className="flex lg:pr-0 md:px-10 px-6  items-end lg:mt-14 mt-8 h-1/2">
                        <div className="xl:w-1/3 w-2/5 overflow-hidden mr-5 pt-4 pl-4 rounded-md bg-yellow-400">
                            <button type="button" className="flex items-center px-4 py-1 rounded-2xl bg-yellow-300">
                                ...
                                <span className="text-white text-sm ml-2 text-lg">Yangi</span>
                            </button>
                            <div className="flex justify-between items-end">
                                <span className="font-bold uppercase xl:text-3xl lg:text-2xl xl:tracking-widest text-2xl pb-4 text-yellow-600">Pit <br/> <span className="xl:ml-3 lg:ml-2">-</span>sa</span>
                                <img src="./maxWayImages/images/pitsa-main.svg" className="h-32" alt=""/>
                            </div>
                        </div>
                        <div className="xl:w-1/3 w-2/5 overflow-hidden pt-4 pl-4 rounded-md bg-magenta">
                            <button type="button" className="flex items-center px-4 bg-light-magenta py-1 rounded-2xl">
                                ...
                                <span className="text-white text-sm ml-2 text-lg">Ko'p sotilgan</span>
                            </button>
                            <div className="flex justify-between items-end">
                                <span className="font-bold uppercase xl:text-3xl text-2xl tracking-widest pb-4 text-lightest-magenta"><span className="xl:ml-6 lg:ml-4 ml-3">Kom</span> <br/> -bo</span>
                                <img src="./maxWayImages/images/kombo-main.svg" className="h-32" alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
